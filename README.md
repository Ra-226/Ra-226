...
<table style="background-color: white !important; border: none;">
  <tr style="background-color: white !important; border: none;">
    ...
    <td style="background-color: white !important; border: none; text-align: center; padding: 8px 0;">
     ...
     <span>Authors: <b style="font-size: 1.1rem;">$\color{#008080}{\textbf{Lei Zhang}}$</b>, Jianfeng Wang, Jiaojiao Wu, Yunling Wang, Shi-Feng Sun</span><br/>
...
<table style="background-color: white !important; border: none;">
  <tr style="background-color: white !important; border: none;">
    ...
    <td style="background-color: white !important; border: none; text-align: center; padding: 8px 0;">
     ...
     <span>Authors: <b style="font-size: 1.1rem;">$\color{#008080}{\textbf{Lei Zhang}}$</b>, Chuan Chen, Qiyun Tan, Maoxin Hao, Xuekang Yang</span><br/>
